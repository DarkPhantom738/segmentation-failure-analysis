...
from src.analysis.volume_probe_screen import run_volume_probe_screen
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--editing-results",
        type=Path,
        default=Path("outputs_10hour/representation_editing/editing_results.csv"),
    )
    parser.add_argument(
        "--direction-path",
        type=Path,
        default=Path("outputs_10hour/semantic_directions/directions/decoder2__gt_wt_voxels.npz"),
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("outputs_10hour/volume_probe_screen"),
    )
